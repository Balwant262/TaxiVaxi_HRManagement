...
<head>
    <!-- -------------- Meta and Title -------------- -->
    <meta charset="utf-8">
    <title> TaxiVaxi Employee Management System </title>
...
<div id="main">
    ...
    <section id="content_wrapper">
        ...
        <?php if(\Route::getFacadeRoot()->current()->uri() == 'dashboard' || \Route::getFacadeRoot()->current()->uri() == 'welcome' || \Route::getFacadeRoot()->current()->uri() == 'change-password' ||
        \Route::getFacadeRoot()->current()->uri() == 'not-found' ): ?>
        <!-- -------------- Page Footer -------------- -->
        <footer id="content-footer" class="affix">
            <div class="row">
                <div class="col-md-6">
                    <span class="footer-legal">Copyright © TaxiVaxi, All rights reserved. </span>
                </div>
