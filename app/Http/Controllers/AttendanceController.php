<?php
  ...
  class AttendanceController extends Controller
  {
    ...
    public function importAttendanceFile()
    {
      ...
      return view('attendance.upload_file', compact('files'));
    }
    ...
    public function showSheetDetails()
    {
      ...
      return view('attendance.show_attendance_sheet_details', compact('attendances', 'column', 'string', 'dateFrom', 'dateTo'));
    }
