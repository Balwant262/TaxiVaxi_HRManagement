...
class TeamController extends Controller
{
    public function addTeam()
    {
        ...
        return view('team.add_team', compact('emps', 'managers', 'leaders'));
    }
    ...
    public function showTeam()
    {
        ...
        return view('team.show_team', compact('teams'));
    }
    ...
    public function showEdit($id)
    {
        ...
        return view('team.edit_team', compact('edit', 'managers', 'leaders', 'emps', 'team_member'));
    }
