<?php
  ...
  class LeaveController extends Controller
  {
    ...
    public function showLeaveType()
    {
      ...
      return view('leave.show_leave_type', compact('leaves'));
    }
    ...
    public function showEdit($id)
    {
      ...
      return view('leave.add_leave_type', compact('result'));
    }
    ...
    public function doApply()
    {
      ...
      return view('leave.apply_leave', compact('leaves'));
    }
    ...
    public function processApply(Request $request)
    {
      ...
      $team = Team::where('member_id', \Auth::user()->employee->user_id)->first();


      if($team) {
        $tl_id = $team->leader_id;
        $manager_id = $team->manager_id;
        $manager = Employee::where('user_id', $manager_id)->with('user')->first();

        $teamLead = Employee::where('user_id', $tl_id)->with('user')->first();
        $leave->tl_id = $tl_id;
    ...
    public function showMyLeave()
    {
      ...
      return view('leave.show_my_leaves', compact('leaves'));
    }
    ...
    public function showAllLeave()
    {
      ...
      $dateFrom = '';
      $dateTo = '';
      return view('leave.total_leave_request', compact('leaves', 'column', 'string','dateFrom','dateTo'));
    }
    ...
    {
      $leaves = LeaveType::get();
      return view('leave.leave_draft', compact('leaves'));
    }
    ...
    public function searchLeave(Request $request)
    {
      try
      {
        ...
        if ($request->button == 'Search')
        {
          ...
          return view('leave.total_leave_request', compact('leaves', 'post', 'column', 'string','dateFrom','dateTo'));
        }
        else
        {
          /**
