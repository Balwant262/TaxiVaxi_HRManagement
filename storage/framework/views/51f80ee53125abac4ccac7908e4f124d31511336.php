                                            ...
                                            <table class="table table-bordered nobodytable" tabindex="0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="width:80%"><?php echo e($notification->date_time); ?></td>
                                                        ...
                                                        <td class="text-center" style="width:10%">
                                                            <div class="btn-group text-right">
                                                                ...
                                                                <ul class="dropdown-menu" notification="menu">
                                                                    <li>
                                                                        <a href="/edit-notification/<?php echo e($notification->id); ?>">Edit</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="/delete-notification/<?php echo e($notification->id); ?>">Delete</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:80%"><?php echo e($notification->name); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th style="background-color:#e0e0e0; width:15%"> Details </th>
                                                        <td style="background-color:#edf3ff; font-size: 14px; width:80%"><b><?php echo e($notification->details); ?></b></td>
                                                    </tr>
                                                </tbody>
                                            </table>
