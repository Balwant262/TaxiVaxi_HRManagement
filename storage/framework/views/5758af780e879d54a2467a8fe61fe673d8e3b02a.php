                ...
                <div class="col-xs-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <?php if(\Route::getFacadeRoot()->current()->uri() == 'edit-announcement/{id}'): ?>
                                <span class="panel-title hidden-xs"> Edit Announcement </span>
                                <?php else: ?>
                                   <span class="panel-title hidden-xs"> Add Announcement </span>
                               <?php endif; ?>
                        </div>
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php else: ?>
                                                    <input type="text" name="name" id="input002" class="select2-single form-control" placeholder="Announcement" required>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <?php else: ?>
                                                        <textarea class="select2-single form-control" rows="3" id="textarea1" placeholder="Announcement Description" name="description" required></textarea>
                                                    <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2"><a href="/add-announcement" >
